...
describe("MigrationFile", () => {
  ...
  it("can load its contents from the filesystem", async () => {
    ...
    const file = new MigrationFile("schema", mock.filename);
